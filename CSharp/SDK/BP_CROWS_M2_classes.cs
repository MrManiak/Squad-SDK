...
// 0x0083 (0x0A38 - 0x09B5)
public class ABP_CROWS_M2_C : ASQVehicleWeapon
{
	#region Offsets
	...
	private ExternalOffset<UClass>                            _offCameraShakeOnFire                                          = new ExternalOffset<UClass>(0x0A28, true);                    // 0x0A28(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	private ExternalOffset<UAnimMontage>                      _offWeaponFireAnim                                             = new ExternalOffset<UAnimMontage>(0x0A30, true);              // 0x0A30(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	#endregion
	...
	public UClass                                             CameraShakeOnFire                                              => _offCameraShakeOnFire.GetValue();
	public UAnimMontage                                       WeaponFireAnim                                                 => _offWeaponFireAnim.GetValue();
	#endregion
