...
public class UIconRadialGotoEntry_C : USQRadialIconButton
{
	#region Offsets
	...
	private ExternalOffset<UTexture2D>                        _offBPIconImageTexture                                         = new ExternalOffset<UTexture2D>(0x0430, true);                // 0x0430(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	private ExternalOffset<UBP_RadialItemModel_C>             _offRelatedActionModel                                         = new ExternalOffset<UBP_RadialItemModel_C>(0x0438, true);     // 0x0438(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	#endregion
