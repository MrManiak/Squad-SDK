...
public class UBP_GotoMenuActionModel_C : UBP_RadialActionModel_C
{
	#region Offsets
	...
	private ExternalOffset<UClass>                            _offGotoMenuModel                                              = new ExternalOffset<UClass>(0x00A8, true);                    // 0x00A8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	#endregion
