...
public class UW_ShareRally_C : UUserWidget
{
	#region Offsets
	...
	private ExternalOffset<int>                               _offSquad_ID                                                   = new ExternalOffset<int>(0x0258);                             // 0x0258(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	#endregion
