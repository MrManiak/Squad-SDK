...
public class UBP_MapWidgetMapMarkerWaypointFT_C : USQMapWidgetMapMarkerWaypoint
{
	#region Offsets
	...
	private ExternalOffset<UTextBlock>                        _offTB_FTID                                                    = new ExternalOffset<UTextBlock>(0x02F0, true);                // 0x02F0(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	public UTextBlock                                         TB_FTID                                                        => _offTB_FTID.GetValue();
