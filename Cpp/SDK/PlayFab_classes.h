...
// 0x0900 (FullSize[0x0928] - InheritedSize[0x0028])
class UPlayFabServerAPI : public UOnlineBlueprintCallProxyBase
{
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0028(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_WULP[0x888];                                   // 0x0038(0x0888) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UPlayFabAuthenticationContext*               CallAuthenticationContext;                                 // 0x08C0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                          RequestJsonObj;                                            // 0x08C8(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                          ResponseJsonObj;                                           // 0x08D0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_I3QF[0x50];                                    // 0x08D8(0x0050) MISSED OFFSET (PADDING)
	...
	class UPlayFabServerAPI* STATIC_UnlinkPSNAccount(const struct FServerUnlinkPSNAccountRequest& Request, const struct FScriptDelegate& OnSuccess, const struct FScriptDelegate& OnFailure, class UObject* customData);
	...
	class UPlayFabServerAPI* STATIC_LoginWithXboxId(const struct FServerLoginWithXboxIdRequest& Request, const struct FScriptDelegate& OnSuccess, const struct FScriptDelegate& OnFailure, class UObject* customData);
	...
	class UPlayFabServerAPI* STATIC_LinkPSNAccount(const struct FServerLinkPSNAccountRequest& Request, const struct FScriptDelegate& OnSuccess, const struct FScriptDelegate& OnFailure, class UObject* customData);
	...
	class UPlayFabServerAPI* STATIC_GetStoreItems(const struct FServerGetStoreItemsServerRequest& Request, const struct FScriptDelegate& OnSuccess, const struct FScriptDelegate& OnFailure, class UObject* customData);
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0028(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_ONA8[0xB8];                                    // 0x0038(0x00B8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UPlayFabAuthenticationContext*               CallAuthenticationContext;                                 // 0x00F0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                          RequestJsonObj;                                            // 0x00F8(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                          ResponseJsonObj;                                           // 0x0100(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_QRCT[0x50];                                    // 0x0108(0x0050) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0028(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_2SVT[0x388];                                   // 0x0038(0x0388) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UPlayFabAuthenticationContext*               CallAuthenticationContext;                                 // 0x03C0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                          RequestJsonObj;                                            // 0x03C8(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                          ResponseJsonObj;                                           // 0x03D0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_X7AP[0x50];                                    // 0x03D8(0x0050) MISSED OFFSET (PADDING)
	...
	class UPlayFabMultiplayerAPI* STATIC_UpdateBuildAlias(const struct FMultiplayerUpdateBuildAliasRequest& Request, const struct FScriptDelegate& OnSuccess, const struct FScriptDelegate& OnFailure, class UObject* customData);
	class UPlayFabMultiplayerAPI* STATIC_UntagContainerImage(const struct FMultiplayerUntagContainerImageRequest& Request, const struct FScriptDelegate& OnSuccess, const struct FScriptDelegate& OnFailure, class UObject* customData);
	...
	class UPlayFabMultiplayerAPI* STATIC_ListServerBackfillTicketsForPlayer(const struct FMultiplayerListServerBackfillTicketsForPlayerRequest& Request, const struct FScriptDelegate& OnSuccess, const struct FScriptDelegate& OnFailure, class UObject* customData);
	class UPlayFabMultiplayerAPI* STATIC_ListQosServersForTitle(const struct FMultiplayerListQosServersForTitleRequest& Request, const struct FScriptDelegate& OnSuccess, const struct FScriptDelegate& OnFailure, class UObject* customData);
	...
	class UPlayFabMultiplayerAPI* STATIC_ListBuildAliases(const struct FMultiplayerMultiplayerEmptyRequest& Request, const struct FScriptDelegate& OnSuccess, const struct FScriptDelegate& OnFailure, class UObject* customData);
	...
	class UPlayFabMultiplayerAPI* STATIC_GetServerBackfillTicket(const struct FMultiplayerGetServerBackfillTicketRequest& Request, const struct FScriptDelegate& OnSuccess, const struct FScriptDelegate& OnFailure, class UObject* customData);
	...
	class UPlayFabMultiplayerAPI* STATIC_GetMultiplayerServerLogs(const struct FMultiplayerGetMultiplayerServerLogsRequest& Request, const struct FScriptDelegate& OnSuccess, const struct FScriptDelegate& OnFailure, class UObject* customData);
	...
	class UPlayFabMultiplayerAPI* STATIC_GetBuildAlias(const struct FMultiplayerGetBuildAliasRequest& Request, const struct FScriptDelegate& OnSuccess, const struct FScriptDelegate& OnFailure, class UObject* customData);
	...
	class UPlayFabMultiplayerAPI* STATIC_DeleteBuildAlias(const struct FMultiplayerDeleteBuildAliasRequest& Request, const struct FScriptDelegate& OnSuccess, const struct FScriptDelegate& OnFailure, class UObject* customData);
	...
	class UPlayFabMultiplayerAPI* STATIC_CreateServerBackfillTicket(const struct FMultiplayerCreateServerBackfillTicketRequest& Request, const struct FScriptDelegate& OnSuccess, const struct FScriptDelegate& OnFailure, class UObject* customData);
	...
	class UPlayFabMultiplayerAPI* STATIC_CreateBuildAlias(const struct FMultiplayerCreateBuildAliasRequest& Request, const struct FScriptDelegate& OnSuccess, const struct FScriptDelegate& OnFailure, class UObject* customData);
	class UPlayFabMultiplayerAPI* STATIC_CancelServerBackfillTicket(const struct FMultiplayerCancelServerBackfillTicketRequest& Request, const struct FScriptDelegate& OnSuccess, const struct FScriptDelegate& OnFailure, class UObject* customData);
	...
	class UPlayFabMultiplayerAPI* STATIC_CancelAllServerBackfillTicketsForPlayer(const struct FMultiplayerCancelAllServerBackfillTicketsForPlayerRequest& Request, const struct FScriptDelegate& OnSuccess, const struct FScriptDelegate& OnFailure, class UObject* customData);
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0028(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_BXJ8[0x98];                                    // 0x0038(0x0098) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UPlayFabAuthenticationContext*               CallAuthenticationContext;                                 // 0x00D0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                          RequestJsonObj;                                            // 0x00D8(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                          ResponseJsonObj;                                           // 0x00E0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_RARR[0x50];                                    // 0x00E8(0x0050) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0028(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_2NZ0[0x58];                                    // 0x0038(0x0058) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UPlayFabAuthenticationContext*               CallAuthenticationContext;                                 // 0x0090(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                          RequestJsonObj;                                            // 0x0098(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                          ResponseJsonObj;                                           // 0x00A0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_XVE5[0x50];                                    // 0x00A8(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9HBR[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2DUX[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
// 0x0250 (FullSize[0x0278] - InheritedSize[0x0028])
class UPlayFabGroupsAPI : public UOnlineBlueprintCallProxyBase
{
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0028(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_XO8Y[0x1D8];                                   // 0x0038(0x01D8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UPlayFabAuthenticationContext*               CallAuthenticationContext;                                 // 0x0210(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                          RequestJsonObj;                                            // 0x0218(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                          ResponseJsonObj;                                           // 0x0220(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_D7LC[0x50];                                    // 0x0228(0x0050) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0028(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_XP7V[0x68];                                    // 0x0038(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UPlayFabAuthenticationContext*               CallAuthenticationContext;                                 // 0x00A0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                          RequestJsonObj;                                            // 0x00A8(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                          ResponseJsonObj;                                           // 0x00B0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_J4U8[0x50];                                    // 0x00B8(0x0050) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0028(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_VKZO[0xB8];                                    // 0x0038(0x00B8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UPlayFabAuthenticationContext*               CallAuthenticationContext;                                 // 0x00F0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                          RequestJsonObj;                                            // 0x00F8(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                          ResponseJsonObj;                                           // 0x0100(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_OLW5[0x50];                                    // 0x0108(0x0050) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0028(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_KI91[0x68];                                    // 0x0038(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UPlayFabAuthenticationContext*               CallAuthenticationContext;                                 // 0x00A0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                          RequestJsonObj;                                            // 0x00A8(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                          ResponseJsonObj;                                           // 0x00B0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_L9TC[0x50];                                    // 0x00B8(0x0050) MISSED OFFSET (PADDING)
...
// 0x0A80 (FullSize[0x0AA8] - InheritedSize[0x0028])
class UPlayFabClientAPI : public UOnlineBlueprintCallProxyBase
{
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0028(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_QRDP[0xA08];                                   // 0x0038(0x0A08) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UPlayFabAuthenticationContext*               CallAuthenticationContext;                                 // 0x0A40(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                          RequestJsonObj;                                            // 0x0A48(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                          ResponseJsonObj;                                           // 0x0A50(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_DP0V[0x50];                                    // 0x0A58(0x0050) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0028(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_CZX7[0x68];                                    // 0x0038(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UPlayFabAuthenticationContext*               CallAuthenticationContext;                                 // 0x00A0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                          RequestJsonObj;                                            // 0x00A8(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                          ResponseJsonObj;                                           // 0x00B0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_8PZ4[0x50];                                    // 0x00B8(0x0050) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0028(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_T2C9[0x728];                                   // 0x0038(0x0728) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UPlayFabAuthenticationContext*               CallAuthenticationContext;                                 // 0x0760(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                          RequestJsonObj;                                            // 0x0768(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                          ResponseJsonObj;                                           // 0x0770(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_U05E[0x50];                                    // 0x0778(0x0050) MISSED OFFSET (PADDING)
