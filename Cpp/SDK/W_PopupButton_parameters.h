...
struct UW_PopupButton_C_PreConstruct_Params
{
...
struct UW_PopupButton_C_BndEvt__MainMenu_Button_Development_K2Node_ComponentBoundEvent_14_OnClicked__DelegateSignature_Params
{
...
struct UW_PopupButton_C_ExecuteUbergraph_W_PopupButton_Params
{
	int                                                EntryPoint;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function W_PopupButton.W_PopupButton_C.Clicked__DelegateSignature
struct UW_PopupButton_C_Clicked__DelegateSignature_Params
{
