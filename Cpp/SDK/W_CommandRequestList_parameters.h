...
struct UW_CommandRequestList_C_Init_Action_List_Params
{
};

// Function W_CommandRequestList.W_CommandRequestList_C.Remove Other Request Lists
struct UW_CommandRequestList_C_Remove_Other_Request_Lists_Params
{
};
...
struct UW_CommandRequestList_C_BndEvt__Button_Accept_K2Node_ComponentBoundEvent_0_OnClicked__DelegateSignature_Params
{
...
struct UW_CommandRequestList_C_BndEvt__Button_Deny_K2Node_ComponentBoundEvent_1_OnClicked__DelegateSignature_Params
{
	bool                                               bSelected;                                                 // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	class UMainMenu_Button_C*                          Button;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct UW_CommandRequestList_C_Construct_Params
{
};

// Function W_CommandRequestList.W_CommandRequestList_C.Remove list
struct UW_CommandRequestList_C_Remove_list_Params
{
};

// Function W_CommandRequestList.W_CommandRequestList_C.Control Widget Created
struct UW_CommandRequestList_C_Control_Widget_Created_Params
{
...
struct UW_CommandRequestList_C_Placement_Complete_Params
{
};

// Function W_CommandRequestList.W_CommandRequestList_C.ExecuteUbergraph_W_CommandRequestList
struct UW_CommandRequestList_C_ExecuteUbergraph_W_CommandRequestList_Params
{
