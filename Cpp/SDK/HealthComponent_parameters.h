...
struct UHealthComponent_C_OnTakeRadialDamage_Event_1_Params
{
	class AActor*                                      DamagedActor;                                              // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                              damage;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UDamageType*                                 DamageType;                                                // (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UHealthComponent_C_OnTakePointDamage_Event_1_Params
{
	class AActor*                                      DamagedActor;                                              // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                              damage;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AController*                                 InstigatedBy;                                              // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UHealthComponent_C_ExecuteUbergraph_HealthComponent_Params
{
	int                                                EntryPoint;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function HealthComponent.HealthComponent_C.Health Max__DelegateSignature
struct UHealthComponent_C_Health_Max__DelegateSignature_Params
{
};

// Function HealthComponent.HealthComponent_C.Health Zero__DelegateSignature
struct UHealthComponent_C_Health_Zero__DelegateSignature_Params
{
};

// Function HealthComponent.HealthComponent_C.Health Lost__DelegateSignature
struct UHealthComponent_C_Health_Lost__DelegateSignature_Params
{
...
struct UHealthComponent_C_Health_Gained__DelegateSignature_Params
{
