...
struct ABP_CaptureZoneMain_C_GetTeamId_Params
{
	int                                                ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function BP_CaptureZoneMain.BP_CaptureZoneMain_C.OnTeamChange
struct ABP_CaptureZoneMain_C_OnTeamChange_Params
{
...
struct ABP_CaptureZoneMain_C_ExecuteUbergraph_BP_CaptureZoneMain_Params
{
