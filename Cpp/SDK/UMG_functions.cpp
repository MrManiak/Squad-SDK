...
// Function UMG.WidgetBlueprintLibrary.DrawTextFormattedWithFontInfo
// (Final, Native, Static, Public, HasOutParms, HasDefaults, BlueprintCallable)
// Parameters:
...
void UWidgetBlueprintLibrary::STATIC_DrawTextFormattedWithFontInfo(struct FPaintContext* Context, const struct FText& Text, const struct FVector2D& Position, struct FSlateFontInfo* FontInfo, const struct FLinearColor& Tint)
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.WidgetBlueprintLibrary.DrawTextFormattedWithFontInfo");

	UWidgetBlueprintLibrary_DrawTextFormattedWithFontInfo_Params params;
	params.Text = Text;
...
// Parameters:
// TEnumAsByte<ETextJustify>      InJustification                (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
void URichTextBlock::SetJustification(TEnumAsByte<ETextJustify> InJustification)
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.RichTextBlock.SetJustification");
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// TEnumAsByte<EMenuPlacement>    InPlacement                    (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
