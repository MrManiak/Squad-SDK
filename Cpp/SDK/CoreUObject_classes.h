...
public:
	...
	int                                                PropertySize;                                              // 0x0050(0x0004) NOT AUTO-GENERATED PROPERTY
	int                                                MinAlignment;                                              // 0x0054(0x0004) NOT AUTO-GENERATED PROPERTY
	TArray                                             Script;                                                    // 0x0058(0x0010) NOT AUTO-GENERATED PROPERTY
	...
	TArray                                             ScriptAndPropertyObjectReferences;                         // 0x0088(0x0010) NOT AUTO-GENERATED PROPERTY
...
{
public:
	unsigned char                                      UnknownData_6WHH[0x168];                                   // 0x0098(0x0168) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_BOKY[0x40];                                    // 0x0030(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_1FJD[0x20];                                    // 0x0070(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_BXCE[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_BMVH[0x28];                                    // 0x0070(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_FU0K[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_62DH[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MFYE[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OIFB[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_079V[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_J1VJ[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_R679[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5L47[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_6MO9[0xA0];                                    // 0x0028(0x00A0) MISSED OFFSET (PADDING)
...
public:
	...
	int8_t                                             NumParms;                                                  // 0x009C(0x0001) NOT AUTO-GENERATED PROPERTY
	unsigned char                                      pad_58MFYECLXV[1];                                         // 0x009D(0x0001) NOT AUTO-GENERATED PROPERTY
	int16_t                                            ParmsSize;                                                 // 0x009E(0x0002) NOT AUTO-GENERATED PROPERTY
	...
	unsigned char                                      pad_FFPVWYD5RM[2];                                         // 0x00A6(0x0002) NOT AUTO-GENERATED PROPERTY
	...
	int                                                EventGraphCallOffset;                                      // 0x00B8(0x0004) NOT AUTO-GENERATED PROPERTY
	unsigned char                                      pad_7EGYOSPMQY[4];                                         // 0x00BC(0x0004) NOT AUTO-GENERATED PROPERTY
...
{
public:
	unsigned char                                      UnknownData_EQNL[0x1B8];                                   // 0x00C8(0x01B8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_D9LL[0xC8];                                    // 0x0028(0x00C8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_P10U[0x1B8];                                   // 0x0200(0x01B8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_NCBU[0x10];                                    // 0x0070(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_NV1Q[0x30];                                    // 0x0030(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_V4PS[0xB8];                                    // 0x0028(0x00B8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_AQSD[0x68];                                    // 0x0200(0x0068) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZB8L[0x10];                                    // 0x00C8(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QMZ0[0x68];                                    // 0x0028(0x0068) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_C4JO[0x10];                                    // 0x0098(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3WPR[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_15WJ[0x48];                                    // 0x0028(0x0048) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TN78[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4SDJ[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
