...
struct USQNetInfoWidgetSlot_C_GetTitleText_Params
{
	struct FText                                       ReturnValue;                                               // (Parm, OutParm, ReturnParm)
};

// Function SQNetInfoWidgetSlot.SQNetInfoWidgetSlot_C.OnFail_9D89973243B31B6470A48FB1F15C4057
struct USQNetInfoWidgetSlot_C_OnFail_9D89973243B31B6470A48FB1F15C4057_Params
{
...
struct USQNetInfoWidgetSlot_C_OnSuccess_9D89973243B31B6470A48FB1F15C4057_Params
{
	class UTexture2DDynamic*                           Texture;                                                   // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct USQNetInfoWidgetSlot_C_ExecuteUbergraph_SQNetInfoWidgetSlot_Params
{
