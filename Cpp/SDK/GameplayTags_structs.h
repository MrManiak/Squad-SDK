...
struct FGameplayTagSource
{
	...
	unsigned char                                      UnknownData_PIT6[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_DQY0[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_RVFD[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6KV0[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FRestrictedGameplayTagTableRow : public FGameplayTagTableRow
{
	...
	unsigned char                                      UnknownData_IA85[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FGameplayTagQuery
{
	...
	unsigned char                                      UnknownData_LQ1K[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
