...
struct UBP_VoiceAction_C_OnClicked_Params
{
...
struct UBP_VoiceAction_C_ExecuteUbergraph_BP_VoiceAction_Params
{
	int                                                EntryPoint;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function BP_VoiceAction.BP_VoiceAction_C.DoAction__DelegateSignature
struct UBP_VoiceAction_C_DoAction__DelegateSignature_Params
{
