...
class ABP_40MM_VOG_Proj2_C : public ASQMortarProjectile
{
public:
	...
	class UChildActorComponent*                        Shockwave;                                                 // 0x0530(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_40MM_VOG_Proj2.BP_40MM_VOG_Proj2_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_40MM_VOG_Proj2(int EntryPoint);
};
