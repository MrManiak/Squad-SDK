...
struct UW_Slider_UIScale_C_BndEvt__SettingsItem_Slider_K2Node_ComponentBoundEvent_0_OnCaptureEnd__DelegateSignature_Params
{
	float                                              Value;                                                     // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function W_Slider_UIScale.W_Slider_UIScale_C.Set Value
struct UW_Slider_UIScale_C_Set_Value_Params
{
	float                                              Value;                                                     // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function W_Slider_UIScale.W_Slider_UIScale_C.Construct
struct UW_Slider_UIScale_C_Construct_Params
{
};

// Function W_Slider_UIScale.W_Slider_UIScale_C.ExecuteUbergraph_W_Slider_UIScale
struct UW_Slider_UIScale_C_ExecuteUbergraph_W_Slider_UIScale_Params
{
