...
public:
	...
	unsigned char                                      UnknownData_VQC7[0x7];                                     // 0x00E9(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JCSO[0x4];                                     // 0x00DC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VGC9[0x7];                                     // 0x00F1(0x0007) MISSED OFFSET (PADDING)
...
public:
	float                                              Magnitude;                                                 // 0x00D8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_6WIB[0x4];                                     // 0x00DC(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_DFZS[0x8];                                     // 0x00E8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QWBZ[0xF];                                     // 0x0121(0x000F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_7PLS[0x3];                                     // 0x0105(0x0003) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JD1B[0x7];                                     // 0x00F9(0x0007) MISSED OFFSET (PADDING)
...
public:
	float                                              Magnitude;                                                 // 0x00D8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_3PSR[0x4];                                     // 0x00DC(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_3HVM[0x7];                                     // 0x00F1(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_Z6IY[0x4];                                     // 0x00DC(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_F4Q6[0x7];                                     // 0x00D9(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_4ONM[0x4];                                     // 0x00DC(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_3CL3[0x10];                                    // 0x0410(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6MHF[0x10];                                    // 0x0430(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_I7JP[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
