...
struct FClothConfig
{
	...
	unsigned char                                      UnknownData_0EK1[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1DW4[0x3];                                     // 0x00BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FClothLODData
{
	...
	unsigned char                                      UnknownData_YIYF[0x20];                                    // 0x00D8(0x0020) MISSED OFFSET (PADDING)
...
struct FClothParameterMask_PhysMesh
{
	...
	unsigned char                                      UnknownData_3EDF[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QICW[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C57C[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
