...
{
	unsigned char                                      UnknownData_72FQ[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
struct FAnimationSharingScalability
{
	...
	unsigned char                                      UnknownData_JRJ6[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimationSetup
{
	...
	unsigned char                                      UnknownData_8H8D[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimationStateEntry
{
	...
	unsigned char                                      UnknownData_DHBU[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XZMA[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_12CE[0x1];                                     // 0x0023(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DROO[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
