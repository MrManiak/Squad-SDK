...
// BlueprintGeneratedClass BP_RPG7_Heat_Proj2.BP_RPG7_Heat_Proj2_C
// 0x0020 (FullSize[0x0540] - InheritedSize[0x0520])
class ABP_RPG7_Heat_Proj2_C : public ASQMortarProjectile
{
public:
	...
	class USoundBase*                                  BPSoundonUnderMinFlightTime;                               // 0x0538(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_RPG7_Heat_Proj2.BP_RPG7_Heat_Proj2_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_RPG7_Heat_Proj2(int EntryPoint);
};
