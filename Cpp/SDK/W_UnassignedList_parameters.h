...
struct UW_UnassignedList_C_Update_List_Params
{
};

// Function W_UnassignedList.W_UnassignedList_C.Construct
struct UW_UnassignedList_C_Construct_Params
{
};

// Function W_UnassignedList.W_UnassignedList_C.Refresh Invite List
struct UW_UnassignedList_C_Refresh_Invite_List_Params
{
};

// Function W_UnassignedList.W_UnassignedList_C.Close List
struct UW_UnassignedList_C_Close_List_Params
{
};

// Function W_UnassignedList.W_UnassignedList_C.Button Selection Changed
struct UW_UnassignedList_C_Button_Selection_Changed_Params
{
...
struct UW_UnassignedList_C_BndEvt__Button_InviteAll_K2Node_ComponentBoundEvent_128_OnClicked__DelegateSignature_Params
{
	bool                                               bSelected;                                                 // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	class UMainMenu_Button_C*                          Button;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct UW_UnassignedList_C_BndEvt__Button_InviteSelected_K2Node_ComponentBoundEvent_133_OnClicked__DelegateSignature_Params
{
	bool                                               bSelected;                                                 // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	class UMainMenu_Button_C*                          Button;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct UW_UnassignedList_C_ExecuteUbergraph_W_UnassignedList_Params
{
