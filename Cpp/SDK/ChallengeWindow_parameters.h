...
struct UChallengeWindow_C_BndEvt__AcceptButton_K2Node_ComponentBoundEvent_1_OnClicked__DelegateSignature_Params
{
...
struct UChallengeWindow_C_BndEvt__DenyButton_K2Node_ComponentBoundEvent_2_OnClicked__DelegateSignature_Params
{
	bool                                               bSelected;                                                 // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	class UMainMenu_Button_C*                          Button;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct UChallengeWindow_C_ExecuteUbergraph_ChallengeWindow_Params
{
	int                                                EntryPoint;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function ChallengeWindow.ChallengeWindow_C.OnRightButtonClicked__DelegateSignature
struct UChallengeWindow_C_OnRightButtonClicked__DelegateSignature_Params
{
};

// Function ChallengeWindow.ChallengeWindow_C.OnLeftButtonClicked__DelegateSignature
struct UChallengeWindow_C_OnLeftButtonClicked__DelegateSignature_Params
{
};
