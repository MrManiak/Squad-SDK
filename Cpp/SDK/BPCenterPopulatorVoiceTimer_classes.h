...
#define PADDING_0258 - 0x0000 // Minimum to subtract -> (0000)
class UBPCenterPopulatorVoiceTimer_C : public UBPRadialPopulatorIcon_C
{
public:
	union
	{
		DEFINE_MEMBER_000(0x0000 PADDING_0258, struct FPointerToUberGraphFrame,                                       UberGraphFrame);                                           // 0x0030(0x0008)  (ZeroConstructor, Transient, DuplicateTransient)
	};
