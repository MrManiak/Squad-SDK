...
struct UW_CommandRequestSLConfirm_C_BndEvt__Button_Accept_K2Node_ComponentBoundEvent_0_OnClicked__DelegateSignature_Params
{
...
struct UW_CommandRequestSLConfirm_C_BndEvt__Button_Deny_K2Node_ComponentBoundEvent_1_OnClicked__DelegateSignature_Params
{
	bool                                               bSelected;                                                 // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	class UMainMenu_Button_C*                          Button;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct UW_CommandRequestSLConfirm_C_Construct_Params
{
};

// Function W_CommandRequestSLConfirm.W_CommandRequestSLConfirm_C.Tick
struct UW_CommandRequestSLConfirm_C_Tick_Params
{
...
struct UW_CommandRequestSLConfirm_C_ExecuteUbergraph_W_CommandRequestSLConfirm_Params
{
