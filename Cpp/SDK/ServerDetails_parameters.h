...
struct UServerDetails_C_Update_Favourite_Params
{
};

// Function ServerDetails.ServerDetails_C.Toggle Favourite
struct UServerDetails_C_Toggle_Favourite_Params
{
...
struct UServerDetails_C_Server_Image_Params
{
};

// Function ServerDetails.ServerDetails_C.Refresh
struct UServerDetails_C_Refresh_Params
{
};
...
struct UServerDetails_C_BndEvt__MainMenu_Button_Development_K2Node_ComponentBoundEvent_8_OnClicked__DelegateSignature_Params
{
...
struct UServerDetails_C_BndEvt__Button_Favourite_K2Node_ComponentBoundEvent_0_OnClicked__DelegateSignature_Params
{
	bool                                               bSelected;                                                 // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	class UMainMenu_Button_C*                          Button;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct UServerDetails_C_Construct_Params
{
};

// Function ServerDetails.ServerDetails_C.ExecuteUbergraph_ServerDetails
struct UServerDetails_C_ExecuteUbergraph_ServerDetails_Params
{
	int                                                EntryPoint;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function ServerDetails.ServerDetails_C.Details Join Button__DelegateSignature
struct UServerDetails_C_Details_Join_Button__DelegateSignature_Params
{
};
