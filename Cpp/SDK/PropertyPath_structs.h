...
struct FCachedPropertyPath
{
	...
	unsigned char                                      UnknownData_BVYX[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YPCR[0x10];                                    // 0x0020(0x0010) MISSED OFFSET (PADDING)
...
struct FPropertyPathSegment
{
	...
	unsigned char                                      UnknownData_88IG[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
