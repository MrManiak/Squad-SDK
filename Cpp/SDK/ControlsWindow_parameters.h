...
struct UControlsWindow_C_Unselect_Mode_Button_Params
{
...
struct UControlsWindow_C_PopulateAxisMappings_Params
{
};

// Function ControlsWindow.ControlsWindow_C.PopulateActionMappings
struct UControlsWindow_C_PopulateActionMappings_Params
{
};

// Function ControlsWindow.ControlsWindow_C.GetCategory
struct UControlsWindow_C_GetCategory_Params
{
...
struct UControlsWindow_C_PopulateControlsList_Params
{
};

// Function ControlsWindow.ControlsWindow_C.Construct
struct UControlsWindow_C_Construct_Params
{
};

// Function ControlsWindow.ControlsWindow_C.Control Defaults
struct UControlsWindow_C_Control_Defaults_Params
{
};
...
struct UControlsWindow_C_BndEvt__MainMenu_Button_Development_K2Node_ComponentBoundEvent_68_OnClicked__DelegateSignature_Params
{
...
struct UControlsWindow_C_BndEvt__Button_Aircraft_K2Node_ComponentBoundEvent_2_OnClicked__DelegateSignature_Params
{
	bool                                               bSelected;                                                 // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	class UMainMenu_Button_C*                          Button;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct UControlsWindow_C_BndEvt__Button_Infantry_K2Node_ComponentBoundEvent_3_OnClicked__DelegateSignature_Params
{
	bool                                               bSelected;                                                 // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	class UMainMenu_Button_C*                          Button;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct UControlsWindow_C_BndEvt__Button_Vehicle_K2Node_ComponentBoundEvent_4_OnClicked__DelegateSignature_Params
{
	bool                                               bSelected;                                                 // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	class UMainMenu_Button_C*                          Button;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct UControlsWindow_C_BndEvt__MainMenu_Button_C_0_K2Node_ComponentBoundEvent_0_OnClicked__DelegateSignature_Params
{
	bool                                               bSelected;                                                 // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	class UMainMenu_Button_C*                          Button;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct UControlsWindow_C_ExecuteUbergraph_ControlsWindow_Params
{
