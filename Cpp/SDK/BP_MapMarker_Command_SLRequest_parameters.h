...
struct ABP_MapMarker_Command_SLRequest_C_SetSquad_Params
{
...
struct ABP_MapMarker_Command_SLRequest_C_ReceiveBeginPlay_Params
{
};

// Function BP_MapMarker_Command_SLRequest.BP_MapMarker_Command_SLRequest_C.Owner SL Notify
struct ABP_MapMarker_Command_SLRequest_C_Owner_SL_Notify_Params
{
};

// Function BP_MapMarker_Command_SLRequest.BP_MapMarker_Command_SLRequest_C.ExecuteUbergraph_BP_MapMarker_Command_SLRequest
struct ABP_MapMarker_Command_SLRequest_C_ExecuteUbergraph_BP_MapMarker_Command_SLRequest_Params
{
