...
struct FWidgetNavigationData
{
	...
	unsigned char                                      UnknownData_P71T[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_0Z6L[0x10];                                    // 0x00A8(0x0010) MISSED OFFSET (PADDING)
...
struct FDelegateRuntimeBinding
{
	...
	unsigned char                                      UnknownData_RSWG[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
struct FBlueprintWidgetAnimationDelegateBinding
{
	...
	unsigned char                                      UnknownData_GK26[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWidgetAnimationBinding
{
	...
	unsigned char                                      UnknownData_UCIA[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
struct FUserWidgetPool
{
	...
	unsigned char                                      UnknownData_1CGB[0x60];                                    // 0x0020(0x0060) MISSED OFFSET (PADDING)
...
struct FSlateChildSize
{
	...
	unsigned char                                      UnknownData_AKEZ[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneMarginSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_0L9K[0x7];                                     // 0x02C9(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieScene2DTransformSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_UQ1C[0x3];                                     // 0x04A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimationEventBinding
{
	...
	unsigned char                                      UnknownData_DGUX[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W3DW[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_A4BQ[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
struct FEventReply
{
	unsigned char                                      UnknownData_2H64[0xB8];                                    // 0x0000(0x00B8) MISSED OFFSET (PADDING)
