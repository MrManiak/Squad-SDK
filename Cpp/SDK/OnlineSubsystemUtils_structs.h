...
struct FPlayerReservation
{
	...
	unsigned char                                      UnknownData_M5ZD[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPartyReservation
{
	...
	unsigned char                                      UnknownData_0OXU[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_QKVL[0xB8];                                    // 0x0000(0x00B8) MISSED OFFSET (PADDING)
